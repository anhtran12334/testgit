...
<?php
        ...
        if(isset($_POST['save'])){
            $sql = "INSERT INTO products (name ,price, short_desc, long_desc, thumb, active, slug, hot, quantity, category_id) VALUES ('$productName',$productPrice,'$short_desc','$long_desc','$hinhanh',$productActive,'$slug',$productHot,$productQuantity, $categoryId)";
