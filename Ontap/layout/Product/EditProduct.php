...
<?php
        ...
        $hinhanh_tmp = $_FILES['productImage']['tmp_name'];
        ...
        if(isset($_POST['save'])){
            $sql = "UPDATE `products` SET `name`='$productName',`price`='$productPrice', `short_desc`='$short_desc',`long_desc`='$long_desc',`thumb`='$hinhanh',`active`='$productActive',`slug`='$slug',`hot`='$productHot',`quantity`='$productQuantity', `category_id` = '$categoryId' WHERE id = $id";
        ...
        <div class="right">
            ...
            <div class="content_basic">
                ...
                <form method ="POST" action="" enctype = "multipart/form-data">
                    ...
                    <input type="file" name="productImage" class="col-6"><br/>
